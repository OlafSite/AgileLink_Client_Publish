...
<script lang="ts" setup>
  ...
  import {aceEdit, customAceEdit} from '../utils'
  import { objToStringify } from '/src/utils/form'
  ...
  .then((res: any) => {
    ...
    <body>
      <div class="design-canvas">
        ${globalImport}
        <div class="screen" style="width: ${obj.config.width}px; height: ${obj.config.height}px; background: ${obj.config.background}; color: ${obj.config.primary}; position: relative;">
          <template v-for="(element, index) in screenData.list" :key="index">
...
`;
    nextTick(() => {
      editor.value = customAceEdit(html, 'editJsonCopy', 'html')
    })
  }
