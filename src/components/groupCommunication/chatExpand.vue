<template>
        ...
        <el-popover trigger="click" placement="left-end" :width="300">
            <div class="more">
                        ...
                        <template #default>
                            <div class="show-content">
                                ...
                                <div class="show-button-content">
                                    <button class="show-content-send-single-button">发消息</button>
                                </div>
                ...
                <el-popover placement="bottom" :width="200" trigger="click">
                    <div v-for="(item, index) in memberList" :key="index" class="at-block">
                        <template v-if="chatMemberList.indexOf(item) === -1">
                            <div class="at-avatar">
                                <img src="../../assets/vue.svg" alt="Avatar">
                            </div>
                            <div class="at-name">
    ...
    <div class="chatContainer">
        <el-scrollbar
            style=" max-height:100%; height:625px; min-height:200px;border-bottom: 1.5px solid rgb(220, 220, 220);"
            ...
            <div style="min-height: 667px">
                ...
                <template v-for="(item, index) in messageList" :key="index">
                    <div class="rightContainer">
                        ...
                        <bubbleSelfPicture :content="item.file_content" :avatar="item.sender_avatar"
                            :sender="item.sender_name"
                            v-if="item.sender_id === userId && item.file_content !== '' && item.content === 'true'">
                        </bubbleSelfPicture>
                        <bubbleSelfFile :content="item.file_content" :avatar="item.sender_avatar" :sender="item.sender_name"
                            v-if="item.sender_id === userId && item.file_content !== '' && item.content === 'false'">
                        </bubbleSelfFile>
            ...
            <el-upload ref="upLoads" class="avatar-uploader" :action="uploadUrl" :http-request="upLoadFile"
                ...
                <template #default>
                    ...
                    <el-popover :visible="atChoice" placement="top-start" :width="200">
                        ...
                        <div v-for="(item, index) in chatMemberList.filter((member) => member.id !== user_id)"
                            @click="addAt(item)" :key="index" class="at-block">
                            <div class="at-avatar">
                        ...
                        <template #reference>
                            <font-awesome-icon :icon="['fas', 'at']"
                                style="font-size: 23px; margin-left: 20px;margin-bottom: 3px; " />
                        </template>
                    </el-popover>
                </template>
            </el-upload>
    ...
    <el-dialog v-model="dialogVisible" width="40%" :before-close="handleClose">
        ...
        <el-scrollbar
            style=" max-height:100%; height:600px; min-height:200px;border-bottom: 1.5px solid rgb(220, 220, 220);"
            ...
            <div style="min-height: 667px">
                ...
                <template v-for="(item, index) in searchList" :key="index">
                    <div class="record-block" @mouseenter="item.record_visible = true"
                        @mouseleave="item.record_visible = false">
                        ...
                        <div class="record-right">
                            ...
                            <div class="record-content" v-else-if="item.file_content != '' && item.content == 'false'">[文件]
                            </div>
